...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: 
    // The AddPerson or getNextPerson functions are returning a different value
    ...
    // Defect(s) Found: 
    // Expected Bob, actual value was Sue. GetNextPerson function might be 
    // returning a value not expected.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: Expected Bob, actual value was Sue. GetNextPerson function might be 
    // returning a value not expected.
